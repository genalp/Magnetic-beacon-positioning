...
def init_sys():
    ...
    for x in range(0, 36, 8):
        for y in range(0, 36, 8):
            for z in range(1,22,5):
                sensors.append([x,y,z])
...
def PSO_position():
    pso = PSO(func=obj_fun, n_dim=3, 
              pop=50, max_iter=1000, 
              lb=[0, 0, 0], ub=[40, 40, 30], 
              w=0.9, c1=0.5, c2=0.5)
    pso.run()
...
def test():
    ...
    return np.mean(sorted_data), position
...
#     algorithm_num = 3
#     use_beacon_num = 3
#     save_path = f'data{i}-1.txt'
#     test()

#     # 4个信标
#     beacons.append([[10, 10, 0], 8])
#     # draw_sys()
#     use_beacon_num = 4
#     m.add_beacon([10, 10, 0], 8)
#     m.run()
#     save_path = f'data{i}-2.txt'
#     test()

#     # 5个信标
#     beacons.append([[10, 12.5, 0], 10])
#     # draw_sys()
#     use_beacon_num = 5
#     m.add_beacon([10, 12.5, 0], 10)
#     m.run()
#     save_path = f'data{i}-3.txt'
#     test()

#     # 6个信标
#     beacons.append([[12.5, 10, 0], 12])
#     # draw_sys()
#     use_beacon_num = 6
#     m.add_beacon([12.5, 10, 0], 12)
#     m.run()
#     save_path = f'data{i}-4.txt'
#     test()
...
# err_data = []
# position_data = []
# for i in tqdm(range(200), desc="Processing", unit="sensor"):
#     err, position = test()
#     err_data.append(err)
#     position_data.append(position)
# np.savetxt('err.txt',err_data)
# np.savetxt('position.txt',position_data)